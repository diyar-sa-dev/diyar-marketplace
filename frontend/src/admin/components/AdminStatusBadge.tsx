...
const STATUS_STYLES: Record<string, string> = {
  ...
  refunding: 'bg-amber-50 text-amber-700 border-amber-100',
  authorized: 'bg-blue-50 text-blue-700 border-blue-100',
  requires_action: 'bg-violet-50 text-violet-700 border-violet-100',
  ...
  actioned: 'bg-red-50 text-red-700 border-red-100',
