...
export default function VendorProducts() {
  ...
  const [productsList, setProductsList] = useState<any[]>([
    {
      ...
      stock: 15,
      description:
        'أريكة استرخاء مريحة مغطاة بالمخمل الإيطالي الناعم مع أرجل خشبية صلبة مناسبة لغرف الجلوس والضيوف.',
      width: '220',
      height: '85',
      depth: '90',
      material: 'مخمل إيطالي، خشب زان',
      warranty: 'سنتين',
      colors: ['رمادي', 'بيج'],
    },
    {
      ...
      stock: 5,
      description:
        'طاولة طعام مميزة مصنوعة من الخشب السويدي الطبيعي والمعالج ضد الرطوبة والخدوش تتسع لـ 6 أشخاص.',
      width: '180',
      height: '75',
      depth: '90',
      material: 'خشب سويدي صلب',
      warranty: '3 سنوات',
      colors: ['بني', 'أبيض'],
    },
    {
      ...
      price: 450,
      stock: 0,
      description: 'كرسي مكتب طبي داعم للفقرات والظهر مع مساند قابلة للتعديل وقاعدة بعجلات مرنة.',
      width: '65',
      height: '120',
      depth: '65',
      material: 'بلاستيك مقوى، شبك طبي',
      warranty: 'سنة واحدة',
      colors: ['أسود', 'أزرق'],
    },
    {
      id: 4,
      name: 'سرير مزدوج للزوجين',
      category: 'غرف النوم',
      price: 3200,
      stock: 8,
      description:
        'سرير مزدوج مصمم بأسلوب عصري حديث، لوح خلفي مبطن بالمخمل الفاخر لتوفير أقصى درجات الفخامة والراحة.',
      width: '200',
      height: '140',
      depth: '200',
      material: 'خشب سويدي، قماش قطيفه',
      warranty: '5 سنوات',
      colors: ['كريمي', 'رمادي'],
    },
    {
      ...
      stock: 24,
      description:
        'طاولة قهوة مستديرة أنيقة وعصرية، سطح زجاجي وأرجل معدنية مذهبة لإضفاء لمسة جمالية وفخمة لمحيط المعيشة.',
      width: '90',
      height: '45',
      depth: '90',
      material: 'معدن مذهب، زجاج مقسى',
      warranty: 'سنة واحدة',
      colors: ['ذهبي', 'أسود'],
    },
  ]);
  ...
  const handleDeleteProduct = (id: number, e?: React.MouseEvent) => {
    ...
    if (
      confirm('هل أنت متأكد من حذف هذا المنتج نهائياً من قائمة منتجات متجرك ومخزونك الخاص بالفضاء؟')
    ) {
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4 flex-1 text-right">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-3 rounded-xl border border-gray-100 text-right">
                    ...
                    <span className="font-bold text-diyar-brown text-lg">
                  ...
                  <div className="bg-gray-50 p-3 rounded-xl border border-gray-100 text-right font-sans">
                    ...
                    <span
                      className={`font-bold text-lg ${selectedProduct.stock > 0 ? 'text-green-600' : 'text-red-500'}`}
                    >
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-right">
              <h3 className="font-bold text-diyar-dark mb-4 border-b border-gray-100 pb-3 text-right">
                المواصفات الفنية المكتملة لعملائك
              </h3>
              <div className="space-y-3 font-sans">
                <div className="grid grid-cols-3 py-2 border-b border-gray-50 text-right">
                  ...
                  <span className="col-span-2 text-diyar-dark font-medium text-sm">
                    عرض: {selectedProduct.width} سم | عمق: {selectedProduct.depth} سم | ارتفاع:{' '}
                    {selectedProduct.height} سم
                  </span>
                </div>
                <div className="grid grid-cols-3 py-2 border-b border-gray-50 text-right">
                  ...
                  <span className="col-span-2 text-diyar-dark font-medium text-sm flex gap-1.5 items-center justify-start flex-wrap">
                    {selectedProduct.colors?.map((col: string) => (
                      <span
                        key={col}
                        className="bg-stone-50 px-2 py-0.5 rounded border text-xs text-stone-600"
                      >
                        {col}
                      </span>
                    )) || 'متعدد الألوان'}
                ...
                <div className="grid grid-cols-3 py-2 border-b border-gray-50 text-right">
                  <span className="text-gray-400 block font-bold text-sm">
                    الضمان الفني الممنوح
                  </span>
                  <span className="col-span-2 text-diyar-dark font-medium text-sm bg-amber-50/50 text-diyar-brown px-3 py-0.5 rounded border border-amber-100/55 w-fit">
          ...
          <div className="space-y-6 lg:col-span-1 text-right">
            ...
            <div className="bg-amber-50/40 rounded-2xl border border-amber-100 p-6 text-right font-sans space-y-3 animate-in">
              ...
              <p className="text-xs text-gray-500 leading-relaxed font-sans">
                يمكنك تتبع مبيعات وتوافر هذا المنتج وتحديث شحنته في أي وقت من خلال محرر المخزون
                السريع.
              </p>
              <button
                onClick={(e) => handleOpenEditModal(selectedProduct, e)}
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="text-right">
          ...
          <p className="text-gray-500 text-sm mt-1">
            إدارة منتجاتك، تتبع المخزون، وتفعيل التسويق بالعمولة.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 relative flex-wrap justify-end">
          ...
          <button
            ...
            className="bg-diyar-brown text-white px-4 py-2 rounded-xl text-sm font-bold flex items-center gap-2 hover:bg-[#A67B5B]/90 transition"
          >
            <Plus size={18} />
            إضافة منتج
          </button>
              ...
              <div className="p-4 flex-1 flex flex-col text-right">
                ...
                <div className="mt-auto space-y-3 font-sans">
                  <div className="flex items-center gap-2 pt-1">
                    <div className="flex-1 text-right">
                      {product.stock > 0 ? (
                        ...
                        <span className="text-red-600 text-xs font-bold flex items-center gap-1 justify-start">
                          <span className="w-2 h-2 rounded-full bg-red-500"></span>نفذت
                        </span>
                      )}
                    </div>
                    <button
                      onClick={() => setSelectedProduct(product)}
                      className="p-2 text-gray-400 hover:text-diyar-brown hover:bg-amber-50 rounded-lg transition cursor-pointer"
                      title="عرض التفاصيل"
                    >
                      <Eye size={18} />
                    </button>
                    ...
                    <button
                      onClick={(e) => handleDeleteProduct(product.id, e)}
                      className="p-2 text-gray-400 hover:text-red-650 hover:bg-red-50 rounded-lg transition cursor-pointer"
                      title="حذف المنتج"
                    >
                      <Trash2 size={18} />
                    </button>
            ...
            <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
              <div className="text-right flex-1 select-none pr-1">
                ...
                <p className="text-gray-400 text-xs mt-0.5 font-sans">
                  تعبئة مواصفات وأبعاد وتسويق المنتج بشكل أفقي منظّم لبيعه على المنصة
                </p>
              </div>
              <button
                type="button"
                ...
                <div className="lg:col-span-5 space-y-6 text-right">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="w-full h-40 border-2 border-dashed border-gray-200 hover:border-diyar-brown/50 rounded-2xl flex flex-col items-center justify-center text-gray-400 bg-gray-50 hover:bg-diyar-brown/5 transition-colors cursor-pointer p-4 group">
                      ...
                      <span className="text-sm font-bold text-diyar-dark mt-3">
                        اسحب أو اضغط لرفع صور المنتج
                      </span>
                      <span className="text-xs text-gray-450 mt-1 font-sans">
                        يدعم JPG, PNG (بحد أقصى 5 صور بدقة عالية)
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50/60 p-4 rounded-2xl border border-gray-100 space-y-4 text-right">
                    <h4 className="text-xs font-bold text-gray-500 pb-2 border-b border-gray-100 text-right">
                      التصنيف وقسم المعيشة
                    </h4>

                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-gray-600 pb-1 block text-right">
                        القسم الرئيسي
                      </label>
                      <select
                        value={prodCategory}
                ...
                <div className="lg:col-span-7 space-y-6 text-right">
                  ...
                  <div className="p-5 bg-stone-50/50 rounded-2xl border border-stone-150 space-y-4 text-right">
                    <h4 className="text-xs font-bold text-stone-600 block border-b border-stone-100 pb-2 text-right">
                      تفاصيل المقاسات والأبعاد والضمان الفني (مهم للزبائن)
                    </h4>
