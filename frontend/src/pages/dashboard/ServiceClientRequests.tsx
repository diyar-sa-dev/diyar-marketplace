...
const MOCK_REQUESTS = [
  {
    ...
    description:
      'أحتاج مصمم داخلي لتصميم صالة جلوس بمساحة 20 متر مربع مع غرفة طعام. المفضل نمط مودرن مع ألوان هادئة. أحب الاستايل الإسكندنافي والخشب الفاتح.',
  ...
  },
  {
    ...
    category: 'نقل وتغليف',
    description:
      'ابغى شركة نقل لنقل أثاث شقة 3 غرف من الدور الثاني الى الدور الارضي في نفس الحي. احتاج فك وتركيب لغرفتين نوم مع التغليف.',
    budget: 'غير محدد',
  ...
  },
  {
    ...
    description:
      'عندي دولاب كبير حق ايكيا (باكس) يحتاج تركيب، بالإضافة لتركيب 3 ستاير مع شاشتين على الجدار.',
    budget: '300 ر.س',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredRequests.map((request) => (
          <Link
            ...
            key={request.id}
            className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col p-5 group block focus:outline-none focus:ring-2 focus:ring-diyar-brown focus:border-transparent"
          >
            ...
            <div className="space-y-2 mb-5">
              ...
              <div className="flex items-center gap-2 text-xs text-gray-500">
                ...
                <span className="font-medium text-gray-700">
                  الميزانية: <span dir="ltr">{request.budget}</span>
                </span>
              </div>
            </div>
