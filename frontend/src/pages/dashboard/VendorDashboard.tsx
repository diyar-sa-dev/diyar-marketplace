  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm md:col-span-2">
          ...
          <div className="flex items-center gap-1 text-sm text-green-600 mt-2">
            <TrendingUp size={16} /> <span>+12.5%</span>{' '}
            ...
            {[1, 2, 3, 4, 5].map((i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-sm text-diyar-dark truncate max-w-30 text-right">
                      أريكة استرخاء مخملية
                    </h4>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-gray-100 rounded-lg overflow-hidden">
                    <img
                      src={`https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&q=80&w=100`}
                      alt={product.name}
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      {product.sales} طلب • {product.stock} متبقي
                    </p>
                  </div>
                </div>
                <div className="text-left font-bold text-diyar-dark">{product.rev} ر.س</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-bold text-red-600 flex items-center gap-2">تنبيهات المخزون</h3>
          </div>
          <div className="space-y-4">
            {[
              {
                name: 'طقم إضاءة حديثة',
                status: 'نفذت الكمية',
                stock: 0,
