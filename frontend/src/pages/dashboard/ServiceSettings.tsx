          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <button className="text-sm font-bold text-blue-600 border border-blue-600 px-4 py-2 rounded-xl hover:bg-blue-50 transition">
                    تغيير الصورة
                  </button>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2 md:col-span-2">
                ...
                <input
                  type="text"
                  defaultValue="مصممة ديكور داخلي"
                  className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <textarea
                  rows={4}
                  defaultValue="خبرة 5 سنوات في تصميم الداخلي السكني والتجاري..."
                  className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                ></textarea>
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                <label className="text-sm font-bold text-gray-700">
                  مناطق العمل (المدن أو الأحياء)
                </label>
                <input
                  type="text"
                  defaultValue="الرياض (جميع الأحياء)، الخرج"
                  className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                />
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  defaultValue="سارة الخالد"
                  className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 bg-gray-50/50"
                />
              </div>
              <div className="space-y-2">
