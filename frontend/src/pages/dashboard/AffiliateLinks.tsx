...
export default function AffiliateLinks() {
  const MOCK_LINKS = [
    {
      id: 1,
      name: 'رابط التسويق لـ أريكة مخملية',
      url: 'https://diyar.sa/p/sofa-velvet?ref=ahm123',
      clicks: 145,
      conversions: 12,
      earn: 1500,
      date: '2024-05-10',
    ...
    {
      id: 2,
      name: 'رابط كرسي مكتب (عرض خاص)',
      url: 'https://diyar.sa/p/office-chair?ref=ahm123',
      clicks: 89,
      conversions: 5,
      earn: 337.5,
      date: '2024-05-12',
    ...
    {
      id: 3,
      name: 'حملة رمضان لغرف الطعام',
      url: 'https://diyar.sa/p/dining-table?ref=ahm123',
      clicks: 320,
      conversions: 0,
      earn: 0,
      date: '2024-03-01',
