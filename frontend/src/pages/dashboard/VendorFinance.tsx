    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            متابعة المبيعات، الأرباح، المستحقات وتفاصيل العمولات.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            className="border border-gray-200 text-gray-600 px-4 py-2 rounded-xl text-sm font-bold flex items-center gap-2 hover:bg-gray-50 transition shadow-sm bg-white"
            onClick={() => alert('يتم تحضير كشف الحساب...')}
          >
            <Download size={18} />
            تصدير تقرير
          </button>
        ...
        <div className="bg-diyar-dark text-white p-6 rounded-2xl shadow-sm relative overflow-hidden md:col-span-2">
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            ...
            <button
              ...
              className="w-full sm:w-auto mt-6 bg-white text-diyar-dark px-6 py-3 rounded-xl font-bold hover:bg-gray-100 transition shadow-sm flex items-center justify-center gap-2"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-6 rounded-2xl border border-amber-100 shadow-sm">
            ...
            <p className="text-sm text-amber-700/80 mb-4">
              سيتم تحويل هذه الدفعة تلقائياً في دورة الدفع القادمة.
            </p>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              {[
                {
                  id: 1,
                  type: 'order',
                  label: 'إيراد طلب #10245',
                  amount: '+1,125',
                  date: '16 مايو 2026، 14:30',
                  status: 'مكتمل',
                ...
                },
                {
                  id: 3,
                  type: 'payout',
                  label: 'سحب رصيد (تحويل بنكي)',
                  amount: '-5,000',
                  date: '15 مايو 2026، 10:00',
                  status: 'جاري المعالجة',
                  statusColor: 'bg-amber-100 text-amber-700',
                  icon: Wallet,
                  color: 'text-diyar-dark',
                  bg: 'bg-gray-100',
                },
                {
                  id: 4,
                  type: 'order',
                  label: 'إيراد طلب #10244',
                  amount: '+850',
                  date: '14 مايو 2026، 18:45',
                  status: 'مكتمل',
                  statusColor: 'bg-green-100 text-green-700',
                  icon: DollarSign,
                  color: 'text-green-600',
                ...
                },
                {
                  id: 5,
                  type: 'refund',
                  label: 'استرجاع طلب #10230',
                  amount: '-450',
                  date: '12 مايو 2026، 09:15',
                  status: 'مكتمل',
                  statusColor: 'bg-green-100 text-green-700',
                  icon: RefreshCcw,
                ...
                <tr key={t.id} className="hover:bg-gray-50/50 transition">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${t.bg} ${t.color}`}
                      >
                        <t.icon size={18} />
                      </div>
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`font-bold inline-block text-left whitespace-nowrap ${t.type === 'order' ? 'text-green-600' : t.type === 'fee' ? 'text-red-600' : 'text-diyar-dark'}`}
                      dir="ltr"
                    >
                      {t.amount} ر.س
                    </span>
                  ...
                  <td className="px-6 py-4">
                    <span className={`px-2.5 py-1 text-xs font-bold rounded-lg ${t.statusColor}`}>
                      {t.status}
                    </span>
                  </td>
                </tr>
        ...
        <div className="p-4 border-t border-gray-100 flex justify-center bg-gray-50/50">
          <button className="text-diyar-brown font-bold text-sm hover:underline">
        ...
        <div className="fixed inset-0 bg-black/60 z-[300] flex items-center justify-center p-4 animate-in fade-in duration-300">
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-2xl w-full max-w-md flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="number"
                      placeholder="0.00"
                      className="w-full pl-4 pr-12 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-diyar-brown focus:ring-1 focus:ring-diyar-brown text-left text-lg font-bold"
                      dir="ltr"
                      max={12450}
                    />
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button className="text-xs font-bold text-diyar-brown hover:underline">
                      إدارة الحسابات
                    </button>
                  </div>
            ...
            <div className="p-6 border-t border-gray-100 flex justify-end gap-3 bg-gray-50 shrink-0">
              ...
              <button
                onClick={() => setIsPayoutModalOpen(false)}
                className="px-6 py-2.5 rounded-xl font-bold bg-diyar-dark text-white hover:bg-black transition"
              >
                تأكيد الطلب
              </button>
            </div>
