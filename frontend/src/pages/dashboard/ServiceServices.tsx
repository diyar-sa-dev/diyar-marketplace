...
export default function ServiceServices() {
  ...
  const MOCK_SERVICES = [
    {
      id: 1,
      title: 'تصميم داخلي (غرفة جلوس)',
      price: 1500,
      duration: 'يومين',
      location: 'الرياض (تغطية كاملة)',
      isActive: true,
    },
    {
      id: 2,
      title: 'استشارة ميدانية',
      price: 500,
      duration: 'ساعتين',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {MOCK_SERVICES.map((service) => (
          ...
          >
            ...
            <h3
              className={`font-bold text-lg mb-2 pt-2 ${service.isActive ? 'text-diyar-dark' : 'text-gray-400'}`}
            >
              {service.title}
            </h3>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
              <span
                className={`font-bold text-xl ${service.isActive ? 'text-blue-600' : 'text-gray-400'}`}
              >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="p-6 overflow-y-auto space-y-6 flex-1">
              <div className="w-full h-32 border-2 border-dashed border-gray-200 rounded-xl flex flex-col items-center justify-center text-gray-400 bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer">
                ...
                <span className="text-sm font-medium text-diyar-dark">
                  اضغط لرفع صور للخدمة (اختياري)
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="مثال: جميع أنحاء الرياض"
                    className="w-full p-2.5 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  rows={3}
                  placeholder="اكتب وصفاً مفصلاً لما تشمله الخدمة..."
                  className="w-full p-2.5 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500"
                ></textarea>
              </div>
              ...
              <div className="flex items-center justify-between border-t border-gray-100 pt-4 mt-2">
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    سيتمكن العملاء من طلب هذه الخدمة إذا كانت مفعلة
                  </p>
                </div>
            ...
            <div className="p-6 border-t border-gray-100 flex justify-end gap-3 bg-gray-50 shrink-0">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl font-bold bg-blue-600 text-white hover:bg-blue-700 transition"
              >
                حفظ الخدمة
              </button>
            </div>
