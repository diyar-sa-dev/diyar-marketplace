      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            تعديل بيانات المتجر، الملف الشخصي، وطرق التواصل.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex items-center gap-6">
                <div className="w-24 h-24 rounded-2xl bg-gray-50 border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-gray-400 relative overflow-hidden group cursor-pointer hover:border-diyar-brown/50 hover:bg-amber-50/20 transition-colors">
                  <img
                    src="https://images.unsplash.com/photo-1616486029423-aaa4789e8c9a?auto=format&fit=crop&q=80&w=200"
                    alt="Logo"
                ...
                <div>
                  <p className="text-sm text-gray-500 mb-2">
                    الصيغ المدعومة: JPG, PNG, SGV. الحد الأقصى للحجم 2MB.
                  </p>
                  <button className="text-sm font-bold text-diyar-brown border border-diyar-brown px-4 py-2 rounded-xl hover:bg-amber-50 transition">
                    تغيير الشعار
                  </button>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  defaultValue="الروائع للأثاث"
                  className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-diyar-brown focus:ring-1 focus:ring-diyar-brown bg-gray-50/50"
                />
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    defaultValue="alrawaea"
                    className="w-full pl-3 pr-9 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-diyar-brown focus:ring-1 focus:ring-diyar-brown bg-gray-50/50 text-left dir-ltr"
                    dir="ltr"
                  />
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm dir-ltr">
                    .diyar.sa
                  </span>
                </div>
              </div>
              <div className="space-y-2 md:col-span-2">
                ...
                <textarea
                  rows={4}
                  defaultValue="متجر متخصص في الأثاث الكلاسيكي والحديث، نقدم قطعاً فريدة..."
                  className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-diyar-brown focus:ring-1 focus:ring-diyar-brown bg-gray-50/50"
                ></textarea>
                <p className="text-xs text-gray-500">
                  هذا الوصف سيظهر للعملاء في صفحة المتجر الرئيسية وعلى محركات البحث.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="email"
                    defaultValue="support@alrawaea.com"
                    className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-diyar-brown focus:ring-1 focus:ring-diyar-brown bg-gray-50/50"
                    dir="ltr"
                  />
                </div>
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
              ...
              <div className="text-sm text-amber-800 leading-relaxed">
                تُستخدم هذه المعلومات لإصدار الفواتير وتحويل مستحقاتك المالية. تأكد من أن جميع
                البيانات المدخلة مطابقة للوثائق الرسمية التي قدمتها أثناء التسجيل لتجنب أي تأخير في
                التحويلات المالية.
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-diyar-brown bg-gray-50/50"
                  />
                </div>
                <div className="space-y-2">
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-diyar-dark border-b border-gray-100 pb-2">
                الحساب البنكي المعتمد للمدفوعات
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-gray-700">اسم البنك</label>
                  <select
                    defaultValue="البنك السعودي الفرنسي"
                    className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-diyar-brown bg-gray-50/50 appearance-none"
                  >
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-gray-700">
                    اسم المستفيد (كما هو في الحساب)
                  </label>
                  <input
                    type="text"
                    defaultValue="مؤسسة الروائع للأثاث"
                    className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-diyar-brown bg-gray-50/50"
                  />
                </div>
                <div className="space-y-2 md:col-span-2">
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      defaultValue="SA45 8010 0000 0000 0000 0000"
                      className="w-full pl-3 pr-10 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-diyar-brown bg-gray-50/50 text-left font-mono"
                      dir="ltr"
                    />
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <p className="text-sm text-gray-500 mb-2">
                    الصيغ المدعومة: JPG, PNG. الحد الأقصى للحجم 2MB.
                  </p>
                  <button className="text-sm font-bold text-diyar-brown border border-diyar-brown px-4 py-2 rounded-xl hover:bg-amber-50 transition">
                    تغيير الصورة
                  </button>
              ...
              <div className="space-y-4">
                {[
                  { id: 1, title: 'طلبات جديدة', desc: 'إشعار عند استلام طلب جديد في متجرك' },
                  {
                    ...
                    desc: 'تنبيه عندما يقل مخزون منتج عن الحد الأدنى',
                  },
                  {
                    id: 3,
                    title: 'الرسائل والمحادثات',
                    desc: 'إشعارات الرسائل الجديدة من العملاء',
                  },
