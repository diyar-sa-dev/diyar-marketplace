    ...
    <div className="min-h-screen bg-gray-50 pb-20 pt-6" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex overflow-x-auto snap-x gap-4 mb-8 pb-4 scrollbar-hide">
          ...
          >
            <LayoutDashboard
              className={`w-8 h-8 mb-3 ${selectedCategory === 'الكل' ? 'text-white' : 'text-diyar-brown'}`}
            />
          ...
          {SERVICE_CATEGORIES.map((category) => (
            ...
            >
              <category.icon
                className={`w-8 h-8 mb-3 ${selectedCategory === category.name ? 'text-white' : 'text-diyar-brown'}`}
              />
