        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:text-diyar-dark hover:bg-gray-50 transition-colors"
            >
              <Settings size={20} />
            </Link>
          </div>
          ...
          {notifications.length > 0 ? (
            <div className="divide-y divide-gray-50">
              {notifications.map((notification) => (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 ${notification.bgColor} ${notification.color}`}
                  >
                    {notification.icon}
                  </div>
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-4 mb-1">
                      <h3
                        className={`font-bold text-base ${!notification.read ? 'text-amber-900' : 'text-gray-800'}`}
                      >
                        {notification.title}
                      </h3>
            ...
            <div className="p-12 text-center flex flex-col items-center justify-center text-gray-500">
              ...
              <p className="text-sm">
                سنقوم بإبلاغك حينما يكون هناك أي تحديثات عن طلباتك أو عروضنا.
              </p>
            </div>
          )}
        </div>
