          ...
          <div className="flex flex-col flex-grow p-2.5 sm:p-4 justify-between h-full">
            <div>
              ...
              <div className="flex flex-wrap items-center gap-1.5 sm:gap-3 mb-1">
                ...
                <div className="flex items-center gap-1 text-diyar-brown text-[8px] sm:text-[9px] bg-orange-50 px-1.5 py-0.5 rounded-md font-medium">
                   <Award size={9} />
                   <span>+50 نقطة</span>
                </div>
              </div>
            ...
            <div className="flex items-baseline gap-2 mb-1">
              <span className="font-bold text-sm sm:text-lg text-diyar-dark">{product.price} ر.س</span>
            ...
            <div className="flex justify-end mt-1">
              <button 
                className="bg-gray-50 text-diyar-dark border border-gray-200 rounded-lg sm:rounded-xl py-1 px-3 sm:py-1.5 sm:px-5 font-bold text-[10px] sm:text-xs transition-all hover:bg-diyar-dark hover:text-white hover:border-diyar-dark flex items-center justify-center gap-1 z-10 relative"
