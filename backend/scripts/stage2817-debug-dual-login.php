...
$meA1 = req($base.'/api/v1/auth/me', $jarA, ['Referer: http://localhost:3000']);
echo "Me A after login A: {$meA1['code']}\n";

$jarB = login($base, ['method' => 'phone', 'identifier' => '500000002', 'password' => 'Password123!'], 'b');
$meB = req($base.'/api/v1/auth/me', $jarB, ['Referer: http://localhost:3000']);
echo "Me B after login B: {$meB['code']}\n";

$meA2 = req($base.'/api/v1/auth/me', $jarA, ['Referer: http://localhost:3000']);
echo "Me A after login B: {$meA2['code']}\n";

echo "Cookie A:\n".file_get_contents($jarA)."\n";
echo "Cookie B:\n".file_get_contents($jarB)."\n";
