...
{
    $jar = sys_get_temp_dir().DIRECTORY_SEPARATOR.'diyar_var_'.$label.'.cookies';
    @unlink($jar);
...
$me1 = req($base.'/api/v1/auth/me', $jarA, ['Referer: http://localhost:3000']);
echo "Me A after login A: {$me1['code']}\n";

$jarB = login($base, ['method' => 'phone', 'identifier' => '500000002', 'password' => 'Password123!'], 'b');
$me2 = req($base.'/api/v1/auth/me', $jarA, ['Referer: http://localhost:3000']);
echo "Me A after login B (no Me B): {$me2['code']}\n";
