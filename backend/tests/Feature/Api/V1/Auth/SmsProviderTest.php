...
class SmsProviderTest extends TestCase
{
    ...
    public function test_log_sms_provider_exposes_plain_otp_only_in_testing_mode(): void
    {
        ...
        Log::shouldHaveReceived('info')->with('otp.sent', \Mockery::type('array'));
        Log::shouldHaveReceived('info')->with('otp.delivery', \Mockery::type('array'));
        Log::shouldHaveReceived('info')->with('sms.log_provider.sent', \Mockery::type('array'));
    ...
    public function test_production_environment_never_logs_plain_otp(): void
    {
        Log::shouldReceive('info')
            ->once()
            ->with('otp.sent', \Mockery::type('array'));
    ...
    public function test_log_driver_is_used_even_when_msegat_credentials_exist(): void
    {
        config([
