...
return [
    ...
    'room_designer' => [
        ...
        'payload_too_large' => 'Design document is too large.',
        'validation_failed' => 'Design validation failed.',
        'cart' => [
            'added' => 'Design items were added to your cart.',
            'empty_selection' => 'No products to add from this design.',
            'invalid_document' => 'Design document is invalid.',
        ],
        'validation' => [
            'schema_version' => 'schema_version is required.',
            'unsupported_schema' => 'Unsupported schema version.',
            'room_required' => 'room is required.',
            'items_required' => 'items must be an array.',
            'item_limit' => 'Too many items (max :max).',
            'item_shape' => 'Invalid item.',
            'item_id' => 'Item id is required.',
            'duplicate_item_id' => 'Duplicate item id.',
            'product_id' => 'Invalid product_id.',
            'invalid_product' => 'One or more products are invalid or unavailable.',
            'position' => 'position_m is required.',
            'snapshot' => 'snapshot is required.',
            'snapshot_name' => 'snapshot.name is required.',
            'room_origin' => 'Invalid room origin.',
            'grid_enabled' => 'grid.enabled must be boolean.',
            'unknown_key' => 'Unknown field :key.',
            'invalid_json' => 'Document is not valid JSON.',
            'non_finite' => 'Value must be a finite number.',
            'non_positive' => 'Value must be positive.',
            'out_of_range' => 'Value must be between :min and :max.',
        ],
    ],

    'try_in_room' => [
        'disabled' => 'Try in your room is not available.',
        'created' => 'Visualization request submitted.',
        'invalid_upload' => 'Invalid upload.',
        'file_too_large' => 'Image is too large.',
        'invalid_type' => 'Unsupported image type.',
        'invalid_extension' => 'Unsupported file extension.',
        'invalid_dimensions' => 'Invalid image dimensions.',
        'dimensions_exceeded' => 'Image dimensions are too large.',
        'pixel_count_exceeded' => 'Image has too many pixels.',
        'storage_failed' => 'Could not store image.',
        'product_not_available' => 'Product is not available.',
        'too_many_active_jobs' => 'Too many active visualization requests. Try again later.',
        ...
        'request_failed' => 'Could not submit visualization request.',
    ],
