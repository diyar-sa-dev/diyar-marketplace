...
return [
    ...
    'services' => [
        ...
        'offers' => [
            ...
            'expired' => 'انتهت صلاحية هذا العرض ولا يمكن قبوله.',
        ],
        'bookings' => [
        ...
        'payments' => [
            ...
            'window_expired' => 'انتهت مهلة الدفع لهذا الحجز.',
        ],
        'catalog' => [
    ...
    'room_designer' => [
        ...
        'version_conflict' => 'تعارض في الإصدار',
        'payload_too_large' => 'مستند التصميم كبير جداً.',
        'validation_failed' => 'فشل التحقق من التصميم.',
        'cart' => [
            'added' => 'تمت إضافة عناصر التصميم إلى السلة.',
            'empty_selection' => 'لا توجد منتجات للإضافة من هذا التصميم.',
            'invalid_document' => 'مستند التصميم غير صالح.',
        ],
        'validation' => [
            'schema_version' => 'schema_version مطلوب.',
            'unsupported_schema' => 'إصدار المخطط غير مدعوم.',
            'room_required' => 'room مطلوب.',
            'items_required' => 'items يجب أن تكون مصفوفة.',
            'item_limit' => 'عدد العناصر كبير (الحد :max).',
            'item_shape' => 'عنصر غير صالح.',
            'item_id' => 'معرف العنصر مطلوب.',
            'duplicate_item_id' => 'معرف عنصر مكرر.',
            'product_id' => 'product_id غير صالح.',
            'invalid_product' => 'منتج واحد أو أكثر غير صالح أو غير متاح.',
            'position' => 'position_m مطلوب.',
            'snapshot' => 'snapshot مطلوب.',
            'snapshot_name' => 'snapshot.name مطلوب.',
            'room_origin' => 'أصل الغرفة غير صالح.',
            'grid_enabled' => 'grid.enabled يجب أن يكون منطقياً.',
            'unknown_key' => 'حقل غير معروف :key.',
            'invalid_json' => 'المستند ليس JSON صالحاً.',
            'non_finite' => 'يجب أن تكون القيمة عدداً محدوداً.',
            'non_positive' => 'يجب أن تكون القيمة موجبة.',
            'out_of_range' => 'يجب أن تكون القيمة بين :min و :max.',
        ],
    ],

    'try_in_room' => [
        'disabled' => 'ميزة جرّب في غرفتك غير متاحة.',
        'created' => 'تم إرسال طلب التصور.',
        'invalid_upload' => 'ملف غير صالح.',
        'file_too_large' => 'حجم الصورة كبير جداً.',
        'invalid_type' => 'نوع الصورة غير مدعوم.',
        'invalid_extension' => 'امتداد الملف غير مدعوم.',
        'invalid_dimensions' => 'أبعاد الصورة غير صالحة.',
        'dimensions_exceeded' => 'أبعاد الصورة كبيرة جداً.',
        'pixel_count_exceeded' => 'عدد البكسلات في الصورة كبير جداً.',
        'storage_failed' => 'تعذر حفظ الصورة.',
        'product_not_available' => 'المنتج غير متاح.',
        'too_many_active_jobs' => 'طلبات تصور نشطة كثيرة. حاول لاحقاً.',
        'invalid_idempotency_key' => 'مفتاح idempotency غير صالح.',
        'idempotency_conflict' => 'مفتاح idempotency مستخدم مسبقاً لطلب مختلف.',
        'request_failed' => 'تعذر إرسال طلب التصور.',
    ],
